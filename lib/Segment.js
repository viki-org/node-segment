...
var { dict } = require('../dicts/dict');
var { dict2 } = require('../dicts/dict2');
var { dict3 } = require('../dicts/dict3');
var { names } = require('../dicts/names');
var { stopword } = require('../dicts/stopword');
var { synonym } = require('../dicts/synonym');
var { wildcard } = require('../dicts/wildcard');
...
Segment.prototype.loadDict = function (name, type, convert_to_lower) {
  ...
  if(name == 'dict.txt') {
    data = dict;
  } else if (name == 'dict2.txt') {
    data = dict2;
  } else if (name == 'dict3.txt') {
    data = dict3;
  } else if (name == 'names.txt') {
    data = names;
  } else if (name == 'wildcard.txt') {
    data = wildcard;
  }
